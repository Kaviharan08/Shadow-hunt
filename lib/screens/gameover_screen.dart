                        ...
                        child: Column(children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  color: mainColor.withOpacity(0.5), width: 2),
                              boxShadow: [
                                BoxShadow(
                            ...
                            child: Icon(
                              _iWon ? Icons.emoji_events : Icons.close,
                              color: mainColor,
                              size: 64,
                            ),
                          ),
                      ...
                      Container(
                        ...
                        child: Column(children: [
                          _row(
                              ...
                              widget.myRole == 'killer'
                                  ? Colors.red
                                  : Colors.blue),
                          const Divider(color: Color(0xFF1A3A1A)),
                          _row('Winner', widget.winnerRole.toUpperCase(),
                              mainColor),
                          const Divider(color: Color(0xFF1A3A1A)),
...
class _TreesBgPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var t in trees) {
      ...
      canvas.drawRect(
          Rect.fromCenter(
              center: Offset(x, y + 14 * s), width: 7 * s, height: 26 * s),
          paint);
      Path p1 = Path()
        ..moveTo(x, y - 52 * s)
        ..lineTo(x - 25 * s, y)
