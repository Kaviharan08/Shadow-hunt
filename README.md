...
|--------|--------|--------------|
| Member 1 | @github1 | Firebase setup, Auth screens |
| Member 2 | @github2 | Lobby & room system |
| Member 3 | @github3 | Hunter game screen |
| Member 4 | @github4 | Survivor screen & tasks |
| Member 5 | @github5 | Leaderboard & profile |
| Member 6 | @github6 | UI/UX, splash & game over |

---

## ⚠️ Important Notes
- Work submitted after deadline = 0 marks
- GitHub repo must be PUBLIC or evaluators given access
- All members must commit individually to GitHub
- Report must not exceed 3000 words
